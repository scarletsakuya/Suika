...
sed -i "s/\[TOKEN]/${TOKEN}/g" /root/.ehforwarderbot/profiles/default/blueset.telegram/config.yaml
sed -i "s/\[ADM]/${ADM}/g" /root/.ehforwarderbot/profiles/default/blueset.telegram/config.yaml
